document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add click handler (this would need actual content loading logic)
    ...
    // Append to the last showcase section
    const lastShowcase = document.querySelector('.showcase-section .showcase-block:last-child');
    if (lastShowcase) {
        lastShowcase.appendChild(loadMoreBtn);
    }
});
